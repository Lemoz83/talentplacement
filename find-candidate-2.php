  ...
  <div class="container">
    ...
    <form class="row" action="#" method="get">
      ...
      <div class="col-md-2 col-sm-2 col-xs-4">
        <button type="submit" class="btn btn-warning btn-effect">
          ...
          <div class="single-candidate row shadow-hover">
            ...
            <div class="col-md-8 col-xs-6 ptb20">
              ...
              <div class="candidate-info mt5">
                <ul class="list-inline">
                  ...
                  <li>
                    <span><i class="fa fa-map-marker"></i>Melbourn,
                      Australia</span>
                  </li>
            ...
            <div class="col-md-2 col-xs-3">
              <div class="candidate-cta ptb30">
                <a href="candidate-profile-1.html" class="btn btn-warning btn-small btn-effect">hire me</a>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-8 col-xs-6 ptb20">
              ...
              <div class="candidate-info mt5">
                <ul class="list-inline">
                  ...
                  <li>
                    <span class="location"><i class="fa fa-briefcase"></i>WordPress
                      Developer</span>
                  </li>
                </ul>
              </div>
