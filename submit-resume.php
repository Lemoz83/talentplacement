...
<section class="ptb80" id="post-job">
  <div class="container">
    <h3 class="uppercase">have an account?</h3>

    <!-- Start of Account Question -->
    <div class="row account-question">
      <div class="col-md-10 nopadding">
        <p class="nomargin">
          If you don’t have an account you can create one on the form below
          by entering your email address. Your account details will be
          confirmed via email.
        </p>
      </div>

      <div class="col-md-2 text-right nopadding">
        <a href="login.html" class="btn btn-warning btn-effect mt5">signin</a>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group pt30 nomargin" id="last">
            <button class="btn btn-warning btn-effect">submit</button>
          </div>
        </div>
      </div>
